...
const RecordRows = memo(function RecordRows({ page, providers, credentials, users, keys, pending, onPage, onPageSize, onSelect }: Props & { onSelect: (record: UsageRecordDto) => void }) {
